...
var _Banner = __webpack_require__(75);
...
var _HotCollection = __webpack_require__(70);
...
var _PlayList = __webpack_require__(73);
...
var Find = function (_migi$Component) {
  ...
  _createClass(Find, [{
    ...
    value: function loadPlayList() {
      ...
      ajax = util.postJSON('api/find/GetFindWorkList', { Parameter: Parameter, Skip: 0, Take: 10, SortType: SortType }, function (res) {
        if (res.success) {
          var data = res.data;
...
var _authorTemplate = __webpack_require__(103);
...
var _Find = __webpack_require__(50);
