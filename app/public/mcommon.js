...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (!helloMessage) {
    var clickClose = function clickClose(e) {
      e.preventDefault();
      quaniang.clean();
