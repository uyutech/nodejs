...
var _WorkComment = __webpack_require__(22);
...
var Works = function (_migi$Component) {
  ...
  _createClass(Works, [{
    ...
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "works"]], [migi.createCp(_Media2.default, [["ref", "media"], ["worksDetail", this.props.worksDetail]]), migi.createCp(_WorkComment2.default, [["ref", "workComment"], ["id", this.props.id], ["commentData", this.props.commentData]]), migi.createVd("div", [["class", "form"], ["ref", "form"]], [migi.createVd("div", [["class", "c"]], [migi.createVd("div", [["class", new migi.Obj("replayId", this, function () {
...
var _LyricsParser = __webpack_require__(19);
...
var Author = function (_migi$Component) {
  ...
  _createClass(Author, [{
    ...
    key: "clickAuthor",
    value: function clickAuthor(e, vd, tvd) {
      var id = tvd.props.id;
      util.goto("/author/" + id);
    }
  }, {
...
var _itemTemplate = __webpack_require__(7);
...
var Media = function (_migi$Component) {
  ...
  _createClass(Media, [{
    ...
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "media"], ["style", 'background-image:url(' + this.props.worksDetail.cover_Pic + ')']], [migi.createCp(_Author2.default, [["ref", "author"], ["authorList", this.authorList]]), migi.createVd("div", [["class", "c"], ["ref", "c"]], [migi.createCp(_Audio2.default, [["ref", "audio"], ["data", this.audioData], ["show", first === 'audio']]), migi.createCp(_Video2.default, [["ref", "video"], ["data", this.videoData], ["show", first === 'video']])]), migi.createVd("div", [["class", new migi.Obj("canControl", this, function () {
...
var WorkComment = function (_migi$Component) {
  ...
  _createClass(WorkComment, [{
    ...
    value: function load() {
      ...
      self.loading = true;
      ajax = _net2.default.postJSON('/api/works/commentList', { id: self.id, skip: skip, take: take, sortType: sortType, myComment: myComment, currentCount: currentCount }, function (res) {
        if (res.success) {
          var data = res.data;
    ...
    value: function checkMore() {
      ...
      if (self.showComment && !self.loading && !loadEnd && bool) {
        self.loading = true;
        ajaxMore = _net2.default.postJSON('api/works/GetToWorkMessage_List', { WorkID: self.worksID, skip: skip, take: take, sortType: sortType, myComment: myComment, currentCount: currentCount }, function (res) {
          if (res.success) {
            var data = res.data;
            currentCount = data.Size;
            skip += take;
...
exports.default = function (data) {
  ...
  var works = migi.preRender(migi.createCp(_Works2.default, [["id", id], ["worksDetail", worksDetail], ["commentData", commentData]]));
...
var _Works = __webpack_require__(6);
