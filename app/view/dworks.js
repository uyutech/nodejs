...
exports.default = function (data) {
  ...
  var authorID = data.ctx.session.authorID;
  ...
  var works = migi.preRender(migi.createCp(_Works2.default, [["isLogin", isLogin], ["authorID", authorID], ["worksID", worksID], ["workID", workID], ["worksDetail", worksDetail], ["labelList", labelList], ["commentData", commentData]]));
...
var _Works = __webpack_require__(77);
...
var _Title = __webpack_require__(78);
...
var _MusicAlbum = __webpack_require__(87);
...
var Works = function (_migi$Component) {
  ...
  _createClass(Works, [{
    ...
    key: 'isManager',
    set: function set(v) {
      this.__setBind("isManager", v);this.__data("isManager");
    },
    get: function get() {
      return this.__getBind("isManager");
    }
  }]);
...
var WorkComment = function (_migi$Component) {
  ...
  _createClass(WorkComment, [{
    ...
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "mod mod-comment box"]], [migi.createVd("h4", [], ["评论"]), migi.createVd("div", [["class", "fn"]], [migi.createVd("ul", [["class", "type fn-clear"], ["onClick", [[{ "li": { "_v": true } }, new migi.Cb(this, this.switchType2)]]]], [migi.createVd("li", [["class", "cur"], ["rel", "0"]], ["全部", migi.createVd("small", [], [this.props.commentData.Count])]), this.props.isLogin ? migi.createVd("li", [["rel", "1"]], ["我的"]) : '']), migi.createVd("ul", [["class", "type2 fn-clear"], ["onClick", [[{ "li": { "_v": true } }, new migi.Cb(this, this.switchType)]]]], [migi.createVd("li", [["class", "cur"], ["rel", "0"]], ["最新"]), migi.createVd("li", [["rel", "1"]], ["最热"])])]), migi.createCp(_Page2.default, [["ref", "page"], ["total", Math.ceil(this.props.commentData.Size / take)]]), migi.createCp(_Comment2.default, [["ref", "comment"], ["zanUrl", "/api/works/likeComment"], ["subUrl", "/api/works/subCommentList"], ["delUrl", "/api/works/delComment"], ["data", this.props.commentData.data]]), this.props.commentData.Size > take ? migi.createCp(_Page2.default, [["ref", "page2"], ["total", Math.ceil(this.props.commentData.Size / take)]]) : '', migi.createCp(_SubCmt2.default, [["ref", "subCmt"], ["originTo", this.props.originTo], ["placeholder", "夸夸这个作品吧"]])]);
    }
  }, {
    key: 'loading',
    set: function set(v) {
...
var _Cover = __webpack_require__(88);
