...
exports.default = function (data) {
  ...
  var user = migi.preRender(migi.createCp(_User2.default, [["userInfo", userInfo], ["userPost", userPost]]));
...
var User = function (_migi$Component) {
  ...
  _createClass(User, [{
    ...
    value: function load(i) {
      ...
      loading = true;
      skip = (i - 1) * take;
      _net2.default.postJSON('/api/my/postList', { userID: $CONFIG.userInfo.UID, skip: skip, take: take }, function (res) {
        if (res.success) {
...
var Profile = function (_migi$Component) {
  ...
  _createClass(Profile, [{
    key: 'render',
    value: function render() {
      return migi.createVd("div", [["class", "profile fn-clear"]], [migi.createVd("h4", [], ["TA的资料"]), migi.createVd("div", [["class", "pic"], ["onClick", new migi.Cb(this, this.clickPic)]], [migi.createVd("img", [["src", new migi.Obj("head", this, function () {
